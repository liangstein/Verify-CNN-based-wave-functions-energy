The convolutional neural network (CNN) based wave-functions for J1-J2 model and t-J model are presented in [a recent paper](https://sc22.supercomputing.org/presentation/?id=pap540&sess=sess170), and the interested reader can verify the energy results using the Python scripts in this repository.
